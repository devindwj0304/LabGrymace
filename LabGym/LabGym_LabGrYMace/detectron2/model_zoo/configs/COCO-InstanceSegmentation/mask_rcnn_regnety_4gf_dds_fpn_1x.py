...
from LabGym_LabGrYMace.detectron2.modeling.backbone import RegNet
from LabGym_LabGrYMace.detectron2.modeling.backbone.regnet import SimpleStem, ResBottleneckBlock
