...
from LabGym_LabGrYMace.detectron2.layers import CNNBlockBase, Conv2d, get_norm
from LabGym_LabGrYMace.detectron2.modeling import BACKBONE_REGISTRY
from LabGym_LabGrYMace.detectron2.modeling.backbone.resnet import (
    BasicStem,
    BottleneckBlock,
