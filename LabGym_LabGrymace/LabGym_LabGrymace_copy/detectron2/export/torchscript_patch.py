...
import LabGym_LabGrymace_copy.detectron2  # noqa F401
from LabGym_LabGrymace_copy.detectron2.structures import Boxes, Instances
from LabGym_LabGrymace_copy.detectron2.utils.env import _import_file
...
import LabGym_LabGrymace_copy.detectron2
from LabGym_LabGrymace_copy.detectron2.structures import Boxes, Instances
...
def patch_builtin_len(modules=()):
    ...
    with ExitStack() as stack:
        MODULES = [
            "LabGym.detectron2.modeling.roi_heads.fast_rcnn",
            "LabGym.detectron2.modeling.roi_heads.mask_head",
            "LabGym.detectron2.modeling.roi_heads.keypoint_head",
        ] + list(modules)
...
def patch_nonscriptable_classes():
    ...
    from LabGym_LabGrymace_copy.detectron2.modeling.backbone import ResNet, FPN
    ...
    from LabGym_LabGrymace_copy.detectron2.modeling.roi_heads import StandardROIHeads
