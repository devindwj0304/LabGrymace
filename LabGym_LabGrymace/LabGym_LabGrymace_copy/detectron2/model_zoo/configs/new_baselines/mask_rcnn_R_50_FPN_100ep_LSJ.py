...
from LabGym_LabGrymace_copy.detectron2.config.lazy import LazyCall as L
from LabGym_LabGrymace_copy.detectron2.layers.batch_norm import NaiveSyncBatchNorm
