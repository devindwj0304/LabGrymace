...
from LabGym_LabGrymace_copy import myargparse
import LabGym_LabGrymace_copy  # get __version__ from __init__.py
...
def test_parse_args_version(monkeypatch, capsys):
    ...
    assert (capsys.readouterr().out
         == f'LabGym.__version__: {LabGym_LabGrymace.__version__}\n')
    assert exitstatus(e.value) == 0
